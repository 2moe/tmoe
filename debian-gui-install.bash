...
####################################################
DEBIANMENU() {
	OPTION=$(whiptail --title "输debian-i启动本工具,Development date 2020-02-22" --menu "请使用方向键和回车键进行操作。Please use the arrow and enter key to operate.当前主菜单下共有12个选项，请使用方向键或触屏滑动，按回车键确认。" 10 55 4 \
