...
####################################################
DEBIANMENU() {
	OPTION=$(whiptail --title "Tmoe-Debian Tool输debian-i启动本工具(20200229)" --menu "Type 'debian-i' to start this tool.Please use the arrow and enter key to operate.当前主菜单有十几个选项，请使用方向键或触屏上下滑动，按回车键确认。" 15 50 4 \
