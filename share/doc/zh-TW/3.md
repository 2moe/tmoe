...
> 2. github code space（程式碼空間）, 假設某倉庫為 github.com/xx/yy, 將 com 修改為 dev：（github.dev/xx/yy） 就是 code space 了。
...
有很多人都喜歡 **JetBrains** 系列的 IDE, 還有 **vscode** 的老大哥 **Visual Studio**。  
...
對於 2moe 來說，使用 vscode 的主要原因是習慣了。

---

有人說 vscode 是一款娛樂軟體，這是一個有趣的想法。  
...
vscode 作為一款在摸魚界裡久負盛名的一款軟體，自然是能玩遊戲的啦！  
...
| ---------------- | -------------------------------- | ---- |
| [上一章](./2.md) | 錯誤處理                         | 2.md |
| [下一章](./4.md) | 深入理解作業系統底層的概念與原理 | 4.md |
