...
| [第一章](./1.md)    | \*                            | 1.md      |
| [第二章](./2.md)    | \*                            | 2.md      |
| 第三章              | 了解一些常见容器 & 环境的用法 | 3.md      |

非常开心您能看到这一章！  
对于用户来说，tmoe 本身的东西需要了解到东西并不多。  
在本章中，我们将主要了解 tmoe 之外的事情。
...
> 2. github code space（代码空间）, 假设某仓库为 github.com/xx/yy, 将 com 修改为 dev：（github.dev/xx/yy） 就是 code space 了。
...
有很多人都喜欢 **JetBrains** 系列的 IDE, 还有 **vscode** 的老大哥 **Visual Studio**。  
...
对于 2moe 来说，使用 vscode 的主要原因是习惯了。

---

有人说 vscode 是一款娱乐软件，这是一个有趣的想法。  
我们不会在本节一开头就介绍它是如何娱乐的，之后会慢慢讲到的。  
...
| Alt+F4                                | Alt+F4                        | ⌘Q              | Quit vscode                           | 退出 vscode                                     |
...
vscode 作为一款在摸鱼界里久负盛名的一款软件，自然是能玩游戏的啦！  
~~在本小节中，我们将简单了解如何使用 vscode 来玩游戏。~~  
。。。
...
| ---------------- | -------------------------------- | ---- |
| [上一章](./2.md) | 错误处理                         | 2.md |
| [下一章](./4.md) | 深入理解操作系统底层的概念与原理 | 4.md |
