...
> If you do not understand the following readme, please report an [issue](https://github.com/2moe/tmoe-linux/issues/new/choose), you can use čeština, Deutsch, español, français, ру́сский, português & 中文, etc.  
...
> When you are using the tool, you can use the touch screen to swipe and press enter to confirm.  
...
For example, if you want to start **debian-sid_amd64** systemd-nspawn container, the command is
